  ...
  en: {
    translation: {
      ...
      invites: {
        ...
        success: {
          title: 'Congratulations, you joined the room!',
          subtitle: 'You have successfully joined the room "{{roomName}}"',
          description: 'Now you can communicate with the members of this room',
      ...
      rooms: {
        management: {
          ...
          subtitle: 'Manage room settings and members',
          action: 'Manage Room',
          tabs: {
            overview: 'Overview',
            members: 'Members',
  ...
  ru: {
    translation: {
      ...
      invites: {
        ...
        success: {
          title: 'Поздравляем, вы присоединились к комнате!',
          subtitle: 'Вы успешно присоединились к комнате "{{roomName}}"',
          description: 'Теперь вы можете общаться с участниками этой комнаты',
          goToChannels: 'Перейти в каналы',
        },
      ...
      rooms: {
        management: {
          ...
          subtitle: 'Управление настройками и участниками комнаты',
          action: 'Управление комнатой',
          tabs: {
            overview: 'Обзор',
            members: 'Участники',
          ...
          updateFailed: 'Не удалось обновить комнату',
          copyFailed: 'Не удалось скопировать ссылку',
          updateMemberRoleFailed: 'Не удалось обновить роль участника',
        },
      },
      channels: {
        title: 'Каналы',
